...
export type ChatSite = 'gemini' | 'chatgpt' | 'claude' | 'deepseek' | 'doubao' | 'grok'
export type WebAgentLanguage = 'en' | 'zh-CN'
...
export interface WebAgentStore {
  version: number
...
export interface WebAgentViewState {
