import type { ChatSite, ExternalModelConfig, GroupRole, WebAgentStore } from './types'
...
export function contextCharBudgetForRole(store: WebAgentStore, role: GroupRole): number {
