import type { GroupChat, GroupRole, WebAgentSettings } from './types'
...
export function roleMentionLabelOptionsFromSettings(settings: Pick<WebAgentSettings, 'defaultChatSite' | 'externalModelsById'>): RoleMentionLabelOptions {
  return {
