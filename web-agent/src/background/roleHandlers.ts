...
import type { ChatSite, WebAgentStore } from '../group/types'
...
function readChatSite(value: unknown): ChatSite | undefined {
  return value === 'chatgpt' || value === 'claude' || value === 'gemini' || value === 'deepseek' || value === 'doubao' || value === 'grok' ? value : undefined
}
